# CLAUDE.md — Servfixy Collections Owner View

## Project
Owner-facing collections reporting and visibility app. Part of the Servfixy platform for multifamily residential communities in Sun Belt markets.

## Stack
- Frontend: React Web App
- Backend: Node/Express on Railway (auippaj/servfixy)
